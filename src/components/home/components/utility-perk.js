  ...
  return (
    <>
      ...
      >
        {isShown ? (<>
          <div 
           className=" w-[300px] h-auto px-4 py-5   md:h-[350px] md:w-full  md:py-10 md:px-8">
           ...
           <div   data-aos="fade"
        data-aos-duration="1000" className="absolute w-full h-full top-0" onMouseEnter={() => setIsShown(true)}
           onMouseLeave={() => setIsShown(false)}>
          ...
          <div
           ...
           className="cursor-pointer w-[300px] h-auto px-4 py-5   md:h-[100%] md:w-full  md:py-10 md:px-8">
